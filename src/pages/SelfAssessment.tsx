          ...
          <CardContent className="pt-6">
            <div className="space-y-3 text-sm">
              ...
              <ul className="space-y-2 text-muted-foreground ml-4">
                <li>• <strong>Выберите цель и задачу</strong> из списка ниже</li>
                <li>• Самооценка проводится по каждой задаче отдельно</li>
                <li>• <strong>Опишите результат</strong> по задаче — что было достигнуто, какие улучшения реализованы и как это повлияло на показатели</li>
                <li>• <strong>Укажите личный вклад</strong> и влияние на общий результат (желательно с конкретными метриками)</li>
                <li>• <strong>Прикрепите ссылку</strong> на рабочее пространство (доску задач, репозиторий, документ и т. п.), где можно увидеть подтверждение прогресса</li>
                <li>• <strong>Оцените себя</strong> по командной работе, вовлечённости и удовлетворённости результатом</li>
                <li>• <strong>Сохраните черновик</strong> и при необходимости вернитесь позже или отправьте готовую версию</li>
                <li>• После отправки самооценка будет учтена при общей оценке эффективности</li>
              </ul>
            </div>
          </CardContent>
        </Card>
